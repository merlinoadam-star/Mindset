...
export const LESSONS: MentalLesson[] = [
  {
    id: "growth-mindset",
    ...
    sections: [
      ...
      },
      {
        ...
        body: "FIXED talk: 'I'm just not a good serve-receiver.' / 'I'll never beat that kid.' / 'I'm not a natural.' GROWTH talk: 'I haven't figured out serve-receive YET.' / 'I haven't beaten him YET.' / 'I'm building it.' The word YET is the smallest, most powerful change you can make.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "1) INSTRUCTIONAL — 'Keep your hips down.' 'Short arm.' Useful during technical execution. 2) MOTIVATIONAL — 'Let's go.' 'One more.' Useful when energy is fading. 3) REFRAMING — turning 'I'm nervous' into 'I'm energized.' Same feeling, different story.",
      },
      {
      ...
      },
      {
        ...
        body: "Every great athlete has a POWER PHRASE — a short line they repeat under pressure. Jordan Burroughs says 'All I see is gold.' What's yours? Something short, present-tense, and true to who you're becoming.",
      },
    ],
    reflectionPrompt:
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "F — FEEL it briefly (don't suppress — honesty matters). L — LEARN one thing (2 seconds max). U — USE a physical reset (clap, wrist snap, touch the mat). S — SHIFT to the next play. H — HOLD that new focus. From mistake to ready in under 5 seconds.",
      },
      {
        heading: "Why physical matters",
        body: "A physical action (clap, breathe, tap) sends a signal to your brain: 'That moment is OVER.' Without it, the brain can loop the mistake. Ever noticed a wrestler shake their hands after a bad round? That's the reset.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "NARROW focus = one specific thing (the ball, the opponent's hip). BROAD focus = the whole picture (the court, the mat, reading the opponent). You need both. The skill is knowing when to switch.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "1) MASTERY — stuff you've already done well ('I've hit 50 jump serves in a row in practice'). 2) MODELING — seeing others like you succeed. 3) VERBAL PERSUASION — what you and trusted people tell you ('You've done the work'). Stack all three.",
      },
      {
...
export function getLesson(id: string): MentalLesson | undefined {
